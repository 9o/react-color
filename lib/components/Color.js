...
var ColorPicker = (function (_ReactCSS$Component) {
  ...
  function ColorPicker(props) {
    ...
    this.state = (0, _merge2['default'])(_helpersColor2['default'].toState(props.color), {
    ...
    value: function render() {
      ...
      return _react2['default'].createElement(
        ...
        _react2['default'].createElement(
          ...
          _react2['default'].createElement(Picker, _extends({}, this.state, { onChange: this.handleChange, onAccept: this.handleAccept, onCancel: this.handleCancel }))
        ),
